...
function offenseIForm() {
  ...
  const t = 'offense';
  return [
    tok(t, 'OL', 0.40, 0, 73, 'LT'),
    tok(t, 'OL', 0.455, 0, 65, 'LG'),
    tok(t, 'OL', 0.50, 0, 55, 'C'),
    tok(t, 'OL', 0.545, 0, 66, 'RG'),
    tok(t, 'OL', 0.60, 0, 71, 'RT'),
    tok(t, 'TE', 0.655, 0, 85, 'TE'),
    tok(t, 'WR', 0.10, 0, 11, 'X'),
    tok(t, 'QB', 0.50, 0.05, 12, 'QB'),
    tok(t, 'FB', 0.50, 0.13, 44, 'FB'),
    tok(t, 'RB', 0.50, 0.21, 22, 'RB'),
    tok(t, 'WR', 0.86, 0.05, 80, 'Z'),
  ];
}
...
function defense43() {
  ...
  const t = 'defense';
  return [
    tok(t, 'DL', 0.41, -0.03, 91, 'LE'),
    tok(t, 'DL', 0.465, -0.03, 95, 'DT'),
    tok(t, 'DL', 0.535, -0.03, 99, 'NT'),
    tok(t, 'DL', 0.59, -0.03, 92, 'RE'),
    tok(t, 'LB', 0.38, -0.13, 54, 'W'),
    tok(t, 'LB', 0.50, -0.13, 52, 'M'),
    tok(t, 'LB', 0.62, -0.13, 58, 'S'),
    tok(t, 'CB', 0.10, -0.10, 24, 'CB'),
    tok(t, 'CB', 0.90, -0.10, 21, 'CB'),
    tok(t, 'S', 0.40, -0.32, 31, 'FS'),
    tok(t, 'S', 0.60, -0.32, 32, 'SS'),
  ];
}
